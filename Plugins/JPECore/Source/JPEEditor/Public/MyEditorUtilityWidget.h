 ...
 */
UCLASS()
class JPEEDITOR_API UMyEditorUtilityWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
...
#pragma region UserWidgets

	UPROPERTY(meta = (BindWidget))
	UButton* Button_OrganizeWorldOutliner;

	UPROPERTY(meta = (BindWidget))
	UButton* Button_DeleteNullSMActors;
	
	UPROPERTY(meta = (BindWidget))
	UButton* Button_SetTextureParameter;

	UPROPERTY(meta = (BindWidget))
	UButton* Button_SearchAndReplace;

	UPROPERTY(meta = (BindWidget))
	UButton* Button_RemoveEmptyFolders;

	UPROPERTY(meta = (BindWidget))
	UDetailsView* DetailsView_General;

	UPROPERTY(meta = (BindWidget))
	UDetailsView* DetailsView_OrganizeWorldOutliner;

	UPROPERTY(meta = (BindWidget))
	UDetailsView* DetailsView_SetTextureParams;

	UPROPERTY(meta = (BindWidget))
	UDetailsView* DetailsView_SearchAndReplace;
...
public:
	...
	UFUNCTION(CallInEditor, BlueprintCallable)
	TArray<AActor*> GetAllLevelActors() const;
};
