...
UTemplateSettings::UTemplateSettings(const FObjectInitializer& ObjectInitializer)
{
	{
		...
		MinimalTemplate.Description = LOCTEXT("MinimalAsset_Description", "Asset with minimum configuration");
	...
	}
	{
		...
		MinimalAssetEditorTemplate.Description = LOCTEXT("MinimalAssetEditor_Description", "Asset Editor Minimum Configuration");
