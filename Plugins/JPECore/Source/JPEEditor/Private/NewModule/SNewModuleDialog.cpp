...
void SNewModuleDialog::Construct(const FArguments& InArgs)
{
	...
	[
		SNew(SBorder)
		.Padding(18)
		.BorderImage( FMyStyle::GetBrush("Docking.Tab.ContentAreaBrush") )
		[
			SNew(SVerticalBox)
			...
			[
				...
				.ButtonStyle(FMyStyle::Get(), "FlatButton.Default")
				.CancelButtonStyle(FMyStyle::Get(), "FlatButton.Default")
				.FinishButtonStyle(FMyStyle::Get(), "FlatButton.Success")
				.ButtonTextStyle(FMyStyle::Get(), "LargeText")
				//.ForegroundColor(FMyStyle::Get().GetSlateColor("WhiteBrush"))
				...
				[
					...
					[
						...
						[
							SNew(SImage)
							.Image(FMyStyle::GetBrush("MessageLog.Warning"))
						]
				...
				[
					...
					[
						SNew(STextBlock)
						.TextStyle( FMyStyle::Get(), "NewClassDialog.PageTitle" )
					...
					[
						...
						[
							...
							[
								// Gray details panel
								SNew(SBorder)
								.BorderImage(FMyStyle::GetBrush("DetailsView.CategoryTop"))
								...
								[
									...
									[
										...
										[
											SNew(STextBlock)
											.TextStyle( FMyStyle::Get(), "NewClassDialog.SelectedParentClassLabel" )
