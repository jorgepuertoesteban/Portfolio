...
#include "CCAttributeListEntryWidget.generated.h"
 ...
 */
UCLASS()
class CHARACTERCREATIONUI_API UCCAttributeListEntryWidget : public UUserWidget, public IUserObjectListEntry
{
	GENERATED_BODY()
...
public:
	...
	bool IsListItemSelectable() const override { return CCAttributeDH != nullptr; }
